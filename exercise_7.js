...
// (extraction will occur up to, but not including the element at this index). Consider this:
...
// that takes an array as an argument. Modify the function using slice() to extract information from the argument array and return a new array that contains the string elements warm and sunny.
